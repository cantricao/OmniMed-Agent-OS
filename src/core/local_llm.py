...
@tool
def invoke_clinical_reasoning(
    doctor_query: str, rag_context: str, ocr_text: str, model_name: str
) -> dict:
    """
    ...
    try:
        ...
        print(
            "🧹 [Memory Manager] Unloading Llama-3 to free up VRAM for other tools..."
        )
        del model
        del tokenizer
        ...
        return {"final_diagnosis": ui_report, "voice_summary": voice_summary}
