...
def invoke_clinical_reasoning(doctor_query: str, rag_context: str, ocr_text: str) -> dict:
    ...
    try:
        ...
        system_prompt = (
            ...
            "3. ABSOLUTELY NO ENGLISH WORDS in your output, EXCEPT for standard medical/drug names (e.g., Sultamicillin, Povidine). If something is missing, explain in Vietnamese (e.g., 'Không có thông tin' instead of 'not extracted'). "
