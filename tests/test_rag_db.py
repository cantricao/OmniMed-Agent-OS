...
def test_chroma_database():
    ...
    print("🧠 [RAG Test] Loading embedding model (bkai-foundation-models/vietnamese-bi-encoder)...")
    ...
    if not results:
        print("❌ [RAG Test] No results found. The database might be empty or corrupted.")
        return
